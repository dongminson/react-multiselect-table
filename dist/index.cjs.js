...
const BaseTableData = styled__default["default"].td(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid #e0e0e0;\n  text-align: left;\n  padding: 1.6rem;\n  vertical-align: top;\n  user-select: none;\n  border-left: 1px solid white;\n  border-right: 1px solid white;\n  font-family: 'Roboto', 'Helvetica', 'Arial', sans-serif;\n  font-weight: 400;\n  font-size: 0.875rem;\n  line-height: 1.5rem;\n  letter-spacing: 0.01071em;\n  display: table-cell;\n  color: rgba(0, 0, 0, 0.87);\n  max-width: 20%;\n  min-width: 20%;\n\n  input {\n    box-sizing: border-box;\n    border: none;\n    outline: none;\n    background-color: transparent;\n  }\n\n  &.selected {\n    background-color: #3b82f680;\n    border: 1px solid white;\n  }\n\n  &:first-child {\n    border-top: none;\n  }\n\n  &:not(.selected) {\n    background: #fff;\n  }\n"])));
const TableBody = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement("tbody", null, tableData.map((data, rowIndex) => /*#__PURE__*/React__default["default"].createElement("tr", {
    key: rowIndex
    ...
    return isEditableCell ? /*#__PURE__*/React__default["default"].createElement(BaseTableData, {
      style: cellStyle,
      key: accessor
      ...
      autoFocus: true
    })) : /*#__PURE__*/React__default["default"].createElement(BaseTableData, {
      className: isCellBeingSelected(rowIndex, columnIndex) ? 'selected' : '',
      "data-row": rowIndex,
      "data-column": columnIndex,
      style: cellStyle,
      key: accessor
    }, /*#__PURE__*/React__default["default"].createElement("span", null, tData));
  }))));
};
var TableBody$1 = TableBody;
const TableColumnPropTypes$2 = {
  label: PropTypes__default["default"].string.isRequired,
  accessor: PropTypes__default["default"].string.isRequired,
  sortable: PropTypes__default["default"].bool.isRequired,
  sortbyOrder: PropTypes__default["default"].string
};
({
  tableData: PropTypes__default["default"].array.isRequired,
  columns: PropTypes__default["default"].arrayOf(PropTypes__default["default"].shape(TableColumnPropTypes$2)).isRequired,
  isCellBeingSelected: PropTypes__default["default"].func.isRequired,
  isCellBeingEdited: PropTypes__default["default"].func.isRequired,
  handleInputChange: PropTypes__default["default"].func.isRequired,
  cellStyle: PropTypes__default["default"].object.isRequired
});

var _templateObject$2;
const BaseTableHeader = styled__default["default"].th(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  text-align: left;\n  padding: 1.6rem;\n  vertical-align: top;\n  user-select: none;\n  border-top: 1px solid #e0e0e0;\n  border-bottom: 1px solid #e0e0e0;\n  border-left: 1px solid white;\n  border-right: 1px solid white;\n  font-family: 'Roboto', 'Helvetica', 'Arial', sans-serif;\n  font-weight: 600;\n  font-size: 0.875rem;\n  line-height: 1.5rem;\n  letter-spacing: 0.01071em;\n  display: table-cell;\n  color: rgba(0, 0, 0, 0.87);\n  cursor: pointer;\n  background-repeat: no-repeat;\n  background-position: center right;\n\n  &.up {\n    background: url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='8' height='8' viewBox='0 0 16 16'><path fill='gray' d='M8 0l8 12H0z'/></svg>\")\n      right center no-repeat;\n  }\n\n  &.down {\n    background: url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='8' height='8' viewBox='0 0 16 16'><path fill='gray' d='M8 16l-8-12h16z'/></svg>\")\n      right center no-repeat;\n  }\n\n  &.default {\n    background: url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='8' height='8' viewBox='0 0 16 16'><path fill='gray' d='M8 0l8 8-8 8-8-8 8-8z'/></svg>\")\n      right center no-repeat;\n  }\n"])));
const TableHead = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement("thead", null, /*#__PURE__*/React__default["default"].createElement("tr", null, columns.map(_ref2 => {
    let {
      label,
      accessor,
      sortable
    ...
    return /*#__PURE__*/React__default["default"].createElement(BaseTableHeader, {
      className: cl,
...
({
  columns: PropTypes__default["default"].arrayOf(PropTypes__default["default"].shape(TableColumnPropTypes$1)).isRequired,
  handleSorting: PropTypes__default["default"].func.isRequired,
  headerCellStyle: PropTypes__default["default"].object
});

var _templateObject$1, _templateObject2$1, _templateObject3;
const BaseContextMenu = styled__default["default"].div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  border-bottom-left-radius: 2px;\n  border-bottom-right-radius: 2px;\n  border-top-left-radius: 2px;\n  border-top-right-radius: 2px;\n  box-shadow:\n    rgba(0, 0, 0, 0.2) 0px 2px 4px -1px,\n    rgba(0, 0, 0, 0.14) 0px 4px 5px 0px,\n    rgba(0, 0, 0, 0.12) 0px 1px 10px 0px;\n  color: rgba(0, 0, 0, 0.87);\n  font-family: 'Roboto', 'Helvetica Neue', sans-serif;\n  left: 9px;\n  opacity: 1;\n  padding: 0px;\n  position: fixed;\n  top: 8px;\n  transform-origin: 0px 0px;\n  transition-delay: 0s;\n  transition-duration: 0.2s;\n  transition-property: all;\n  transition-timing-function: cubic-bezier(0.25, 0.8, 0.25, 1);\n  z-index: 100;\n"])));
const MenuItemWrapper = styled__default["default"].div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  background-color: rgb(255, 255, 255);\n  color: rgba(0, 0, 0, 0.87);\n  display: flex;\n  flex-direction: column;\n  font-family: 'Roboto', 'Helvetica Neue', sans-serif;\n  max-height: 304px;\n  min-width: 96px;\n  overflow-y: auto;\n  padding-bottom: 8px;\n  padding-left: 0px;\n  padding-right: 0px;\n  padding-top: 8px;\n  -moz-box-direction: normal;\n  -moz-box-orient: vertical;\n"])));
const MenuItem = styled__default["default"].div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  font-size: 15px;\n  text-transform: none;\n  font-weight: 400;\n  display: flex;\n  align-items: center;\n  flex-direction: row;\n  min-height: 48px;\n  height: 48px;\n  text-align: left;\n  border-radius: 0;\n  margin: auto 0;\n  padding-left: 16px;\n  padding-right: 16px;\n\n  &:hover {\n    background-color: rgba(158, 158, 158, 0.2);\n  }\n"])));
...
const ContextMenu = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(BaseContextMenu, {
    onContextMenu: handleContextMenu,
    style: {
      top: position.y,
      left: position.x
    }
  }, /*#__PURE__*/React__default["default"].createElement(MenuItemWrapper, null, /*#__PURE__*/React__default["default"].createElement(MenuItem, {
    onClick: onEditClick
  }, "Edit"), /*#__PURE__*/React__default["default"].createElement(MenuItem, {
    onClick: onCopyClick
  }, "Copy"), /*#__PURE__*/React__default["default"].createElement(MenuItem, {
    onClick: onPasteClick
  }, "Paste")));
};
var ContextMenu$1 = ContextMenu;
({
  onCopyClick: PropTypes__default["default"].func.isRequired,
  onPasteClick: PropTypes__default["default"].func.isRequired,
...
const useSortableTable = (data, columns) => {
  const [tableData, setTableData] = React.useState(getDefaultSorting(data, columns));
...
const BaseTable = styled__default["default"].table(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  width: 100%;\n  border-spacing: 0;\n  border-radius: 2px;\n  background-color: #fff;\n  box-shadow:\n    0 2px 2px 0 rgba(0, 0, 0, 0.14),\n    0 3px 1px -2px rgba(0, 0, 0, 0.2),\n    0 1px 5px 0 rgba(0, 0, 0, 0.12);\n"])));
const SelectionRectangle = styled__default["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  position: absolute;\n  background-color: rgba(\n    0,\n    123,\n    255,\n    0.3\n  ); /* Change color and opacity as needed */\n  pointer-events: none;\n"])));
...
const Table = _ref => {
  ...
  const [startPastePosition, setStartPastePosition] = React.useState({
    x: -1,
    y: -1
  });
  ...
  const [endPosition, setEndPosition] = React.useState({
    x: -1,
    y: -1
  });
  const [firstCellPosition, setFirstCellPosition] = React.useState({
    x: -1,
    y: -1
  });
  const [lastCellPosition, setLastCellPosition] = React.useState({
    x: -1,
    y: -1
  });
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, contextMenuVisible && /*#__PURE__*/React__default["default"].createElement(ContextMenu$1, {
    onCopyClick: () => {
      handleCopy();
    },
    onPasteClick: () => {
  ...
  }), isSelecting && /*#__PURE__*/React__default["default"].createElement(SelectionRectangle, {
    style: {
  ...
  }), /*#__PURE__*/React__default["default"].createElement(BaseTable, {
    ref: tableRef,
    className: "table",
    onContextMenu: handleContextMenu,
...
({
  ...
  columns: PropTypes__default["default"].arrayOf(PropTypes__default["default"].shape(TableColumnPropTypes)).isRequired,
  cellStyle: PropTypes__default["default"].object.isRequired,
  headerCellStyle: PropTypes__default["default"].object.isRequired
});
({
